package com.example.watertracker.screens.add
...
@Composable
fun AddInTakeCard(modifier: Modifier = Modifier) {
    Card(
        modifier = modifier
            .fillMaxWidth()
            .height(300.dp)
...
@Composable
fun AddInTakeScreen(navController: NavController) {
    DefaultScaffold(
